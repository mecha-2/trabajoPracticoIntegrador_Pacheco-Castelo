...
// Mostramos los libros disponibles en la biblioteca: 
let libros = [
    { id: 1, titulo: "El Principito", disponible: true },
    { id: 2, titulo: "La sombra del viento", disponible: true },
    { id: 3, titulo: "Las mil y una noches", disponible: true }
];

//Presentamos los usuarios del sistema: 
let usuarios = [
    { id: 1, nombre: "Ana", librosPrestados: [] },
    { id: 2, nombre: "Juan", librosPrestados: [] }
];

// a. Debemos marcar el lbro como no disponible y agregarlo a la lista de librosPrestados del usuario.
